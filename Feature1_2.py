...
for i in range(0, CARRIERA.shape[0]): #qui 'riempio' i dati mancanti nella base del diploma esprimento il punteggio in 100esimi
    if np.isnan(CARRIERA.iloc[i]['VOTO_MASSIMO_DIPLOMA']) or CARRIERA.iloc[i]['VOTO_MASSIMO_DIPLOMA'] <= 0:
        CARRIERA.iloc[i, CARRIERA.columns.get_loc('VOTO_MASSIMO_DIPLOMA')] = 100
...
for i in range(0, CARRIERA.shape[0]):
    if np.isnan(CARRIERA.iloc[i]['Voto_Diploma']) or CARRIERA.iloc[i]['Voto_Diploma'] < 60:
        CARRIERA.iloc[i, CARRIERA.columns.get_loc('Voto_Diploma')] = CARRIERA.Voto_Diploma.mean()
...
for i in range(0, CARRIERA.shape[0]):
    if CARRIERA.iloc[i]['Anno_Immatricolazione'] == 2013 and CARRIERA.iloc[i]['Tot_Test'] != -99:
        temp_2013.append(CARRIERA.iloc[i]['Tot_Test'])
    if CARRIERA.iloc[i]['Anno_Immatricolazione'] == 2014 and CARRIERA.iloc[i]['Tot_Test'] != -99:
        temp_2014.append(CARRIERA.iloc[i]['Tot_Test'])
    elif CARRIERA.iloc[i]['Anno_Immatricolazione'] == 2015 and CARRIERA.iloc[i]['Tot_Test'] != -99:
        temp_2015.append(CARRIERA.iloc[i]['Tot_Test'])
    elif CARRIERA.iloc[i]['Anno_Immatricolazione'] == 2016 and CARRIERA.iloc[i]['Tot_Test'] != -99:
        temp_2016.append(CARRIERA.iloc[i]['Tot_Test'])
    elif CARRIERA.iloc[i]['Anno_Immatricolazione'] == 2017 and CARRIERA.iloc[i]['Tot_Test'] != -99:
        temp_2017.append(CARRIERA.iloc[i]['Tot_Test'])
    elif CARRIERA.iloc[i]['Anno_Immatricolazione'] == 2018 and CARRIERA.iloc[i]['Tot_Test'] != -99:
        temp_2018.append(CARRIERA.iloc[i]['Tot_Test'])

for i in range(0, CARRIERA.shape[0]):

    if CARRIERA.iloc[i]['Anno_Immatricolazione'] == 2013:
        if CARRIERA.iloc[i]['Tot_Test'] == -99:
            CARRIERA.iloc[i, CARRIERA.columns.get_loc('Tot_Test')] = np.mean(temp_2013)*VAR_NORM/max(temp_2013)
        else:
            CARRIERA.iloc[i, CARRIERA.columns.get_loc('Tot_Test')] = CARRIERA.iloc[i, CARRIERA.columns.get_loc('Tot_Test')]*VAR_NORM/max(temp_2013)
...
del(temp_2013, temp_2014, temp_2015, temp_2016, temp_2017, temp_2018)
...
#Chiamo i corsi con numeri crescenti
for i in range(0, CARRIERA.shape[0]):
